...
public class Context {
    ...
    /** 上下文附件集合 */
    private static Map<String, Object> attachments = new ConcurrentHashMap<String, Object>();
    /** 上下文ThreadLocal集合 */
    private static Map<String, ThreadLocal<?>> threadLocals = new ConcurrentHashMap<String, ThreadLocal<?>>();

    static {
        try {
            Context.ip = Inet4Address.getLocalHost().getHostAddress();
